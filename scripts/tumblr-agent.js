...
async function postToTumblr(article, tags) {
  ...
  // Strip HTML tags from excerpt for clean plain text
  ...
  const postBody = {
    content: [
      ...
      {
        type: 'text',
        text: `Read the full article at natalai.live →`,
        formatting: [
          {
            start: 0,
            end:   38,
      ...
      {
        type: 'text',
        text: 'Get your free Vedic birth chart at natalai.live — no signup required. Decoded by AI. Rooted in 5,000 years of Vedic tradition.',
      }
    ],
    tags:  tags,
    state: 'published',
