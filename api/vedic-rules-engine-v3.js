...
module.exports = {
  ...
  DASHA_YEARS, DASHA_SEQ, ANTAR_TABLE, BENEFIC_TABLE, PLANET_REMEDIES,
  ...
  computeAshtakavarga, getAVSummaryForPrompt,
  calcD4, calcD7, calcD10, calcD24, buildVargaChart,
  checkIthasala, evaluatePrashnaAspects
};
