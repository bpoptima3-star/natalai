...
<style>
  ...
  /* Body sections light */
  .rep-body{background:#ffffff!important;color:#1d1d1f!important;padding:32px 40px!important;max-width:660px!important}
  .rep-sh{color:#1a1a1a!important;font-size:22px!important;margin-bottom:4px!important;padding-bottom:14px!important}
  /* Watch line amber pill */
  [style*="border-left:2px solid rgba(191,154,48"]{display:block!important;padding:8px 12px!important;margin-top:8px!important;border-radius:4px!important;background:rgba(191,154,48,.06)!important}
  ...
  /* Muted card colors — benefic sage, malefic burgundy */
  [style*="border-left:4px solid #2A6B47"]{border-left:3px solid #2A6B47!important}
  [style*="border-left:4px solid #8B2222"]{border-left:3px solid #8B2222!important}
  /* Color-coded sub-period card borders — preserve in email */
  /* Green (benefic) and red (malefic) left borders pass through as inline */
  /* Section content spacing — override any residual 4px */
  .rep-body > div > div:last-child{padding-top:20px!important;padding-left:16px!important;padding-right:16px!important}
  /* Planet glyphs — ensure they render */
  .p-card-name span{font-family:serif!important}
  /* TOC pill links in summary — make them block in email */
  .toc-link{display:inline-block!important;margin:3px!important;padding:3px 8px!important;border:1px solid rgba(191,154,48,.3)!important;border-radius:20px!important;font-size:11px!important;color:#bf9a30!important;text-decoration:none!important}
  /* Bold first words in summary */
  .summary-card strong{font-weight:600!important;color:#1a1a1a!important}
