...
You are writing a soul compatibility reading for an American audience. Be honest, specific, and personal.
${compatCore}
...
Format: Use ## for section headers. Write in flowing paragraphs with bullet points where appropriate. 1500-2000 words total. Personal, direct, honest.`;

        // ── Cosmic Chemistry — dedicated animal archetype prompt ──────────────
        let finalHtml,finalTitle;
        if(reportType==='cosmic'){
          const cosmicPrompt=`${LANG}
You are a sharp, perceptive astrologer for an American audience. Write a premium Animal Energy Compatibility reading. American English only, direct and intelligent.
${name}: Rising ${lagna}, Moon ${rashi}, Birth Star ${NK[ni1]}, Animal archetype: ${y1}, Nature: ${g1}
${name2||'Partner'}: Rising ${RS[ls2]}, Moon ${RS[ms2]}, Birth Star ${NK[ni2]}, Animal archetype: ${y2}, Nature: ${g2}
...
Format: ## headers, flowing paragraphs, 1400-1800 words. Personal, honest, direct.`;
          const cosmicText=await claude(apiKey,cosmicPrompt,3500);
          ...
          const compatText=await claude(apiKey,compatPrompt,4500);
