...
${name} patterns: ${yogas.map(y=>y.name).join(', ')||'standard'}`;
        ...
        let finalHtml=wrapHTML(compatSections,`${name} + ${name2||'Partner'}`,reportType,{lagna,rashi,nakshatra,dob,y1,y2,y1emoji:YONI_EMOJI[y1]||'✦',y2emoji:YONI_EMOJI[y2]||'✦',name2:name2||'Partner',lagna2:RS[ls2],rashi2:RS[ms2],nakshatra2:NK[ni2]});
