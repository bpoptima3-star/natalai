...
function wrapHTML(sections,name,type,cd){
  ...
  <div style="border-bottom:1px solid rgba(0,0,0,.06);margin-bottom:0">
    <div style="padding:28px 0 0"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:16px"><tr><td style="font-family:Cormorant Garamond,serif;font-size:24px;font-weight:400;color:#1a1a1a;padding-bottom:10px;white-space:nowrap">${s.title}</td><td width="99%" style="padding-left:12px;padding-bottom:10px"><div style="height:1px;background:linear-gradient(to right,#bf9a30,transparent)"></div></td></tr></table></div>
...
Jupiter: house ${todayData.jupTransit.house} from Moon (${todayData.jupTransit.quality})`;
      ...
      const buildSubPeriodCard = (p, interpretation, transitNote) => {
        ...
        return `<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-radius:10px;overflow:hidden;border:1px solid #e0e0e0;background:#ffffff;border-left:3px solid ${p.color||'#bf9a30'};margin-bottom:14px;width:100%">
  <tr>
    <td style="padding:14px 18px 12px;border-bottom:1px solid #eeeeee;background:#ffffff">
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="vertical-align:middle">
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="font-size:20px;line-height:1;padding-right:10px;vertical-align:middle">${p.emoji||'✦'}</td>
                <td style="vertical-align:middle">
                  <div style="font-family:Cormorant Garamond,serif;font-size:19px;font-weight:500;color:#1a1a1a">${p.planet}</div>
                  <div style="font-family:sans-serif;font-size:11px;color:#888888;font-weight:400;margin-top:2px">${p.start} &rarr; ${p.end} &nbsp;&middot;&nbsp; ${p.days} days</div>
                </td>
              </tr>
            </table>
          </td>
          <td align="right" style="vertical-align:middle;white-space:nowrap">${badge}</td>
        </tr>
      </table>
    </td>
  </tr>
  <tr>
    <td style="padding:8px 18px;font-size:11px;font-weight:500;letter-spacing:.04em;border-bottom:1px solid #eeeeee;background:${p.color}18;color:${p.color}">${houseLabel}${statusTag}</td>
  </tr>
  <tr>
    <td style="padding:14px 18px 16px;background:#ffffff">${lines}</td>
  </tr>
</table>`;
      };
