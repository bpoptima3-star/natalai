...
module.exports = async function handler(req, res) {
  ...
  // MODE 1: Direct prompt from full report modal
  ...
  // MODE 2: Free chart from homepage calculator
